...
void _ZN7android13SensorManagerC1Ev(void *sensorMgr)
{
    ...
    _ZN7android8String16C1EPKc(&string, "gps.smdk4210");
...
{
    ALOGI("smdk4210 GPS interposition library loaded. Your GPS should work in M now.");
}
...
{
    ALOGI("smdk4210 GPS interposition library unloading. Goodbye...");
